...
class booking:
    empty_input =                   "Some information is missing."
    end_time_before_start_time =    "Ending time must be after starting time."
    occupied_time_session =         "Selected session is occupied by others."
